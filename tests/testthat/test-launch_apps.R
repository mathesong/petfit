test_that("launch_apps function exists and has expected signature", {
...
test_that("launch_apps validates app choice", {
  expect_error(launch_apps(app = "invalid"), "arg should be one of")
})

test_that("launch_apps validates directory inputs", {
  expect_error(
    launch_apps(app = "regiondef", bids_dir = "/nonexistent/path"),
    "BIDS directory does not exist"
  )
  expect_error(
    launch_apps(app = "modelling_ref", derivatives_dir = "/nonexistent/path"),
