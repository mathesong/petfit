...
For a quick introduction to running PETFit with Docker or Apptainer, see the [Quick start](../quickstart.md). This section covers advanced container options, CLI reference, and HPC integration.
